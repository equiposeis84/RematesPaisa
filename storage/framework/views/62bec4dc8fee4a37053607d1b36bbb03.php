    ...
    <div class="container-sm d-flex justify-content-center mt-5">
        <div class="card">
            <div class="card-body" style="width: 1200px;">
                ...
                <form name="pedidos" action="<?php echo e(url('/pedidos')); ?>" method="GET">
                    ...
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-md-6 text-end">
                           ...
                           <a href="<?php echo e(url('/pedidos')); ?>" class="btn btn-warning"><i class="fas fa-list"></i> Reset</a>
                        </div>
                    </div>
                </form>
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $datos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($item->idPedidos); ?></td> 
                                <td><?php echo e($item->fechaPedido); ?></td>  
                                <td><?php echo e($item->horaPedido); ?></td>
                                <td><?php echo e($item->idCliente); ?></td>  
                                <td>$<?php echo e(number_format($item->valorPedido, 2)); ?></td>
                                <td>$<?php echo e(number_format($item->ivaPedido, 2)); ?></td>
                                <td>$<?php echo e(number_format($item->totalPedido, 2)); ?></td>
                                <td>
                                    <span class="badge 
                                        <?php if($item->estadoPedido == 'Pendiente'): ?> bg-warning
                                        <?php elseif($item->estadoPedido == 'Enviado'): ?> bg-info
                                        <?php elseif($item->estadoPedido == 'Entregado'): ?> bg-success
                                        <?php elseif($item->estadoPedido == 'Cancelado'): ?> bg-danger
                                        <?php else: ?> bg-secondary <?php endif; ?>">
                                        <?php echo e($item->estadoPedido); ?>

                                    </span>
                                </td>
                                <td><?php echo e($item->repartidorPedido ?? 'N/A'); ?></td>
                                <td>
                                    <!-- Botón para gestionar productos del pedido -->
                                    <a href="<?php echo e(route('pedidos.productos.index', $item->idPedidos)); ?>" 
                                    ...
                                    <button type="button" class="btn btn-success btn-sm mb-1" 
                                            ...
                                            data-id="<?php echo e($item->idPedidos); ?>"
                                            data-fecha="<?php echo e($item->fechaPedido); ?>"
                                            data-hora="<?php echo e($item->horaPedido); ?>"
                                            data-cliente="<?php echo e($item->idCliente); ?>"
                                            data-valor="<?php echo e($item->valorPedido); ?>"
                                            data-iva="<?php echo e($item->ivaPedido); ?>"
                                            data-total="<?php echo e($item->totalPedido); ?>"
                                            data-estado="<?php echo e($item->estadoPedido); ?>"
                                            data-repartidor="<?php echo e($item->repartidorPedido); ?>">
                ...
                <div class="alert alert-info text-center mt-3">
                    ...
                    <?php if(request('search')): ?>
                        No se encontraron pedidos con "<?php echo e(request('search')); ?>"
                    <?php else: ?>
    ...
    <div class="modal fade" id="modalPedido" tabindex="-1" aria-labelledby="modalPedidoLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('pedidos.store')); ?>" method="POST" id="formNuevoPedido">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="idPedidos" name="idPedidos" value="<?php echo e($nextId); ?>" required readonly>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="idCliente" name="idCliente" required>
                                                ...
                                                <?php $__currentLoopData = $clientes = \App\Models\Cliente::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($cliente->idCliente); ?>" 
                                                            data-nombre="<?php echo e($cliente->nombreCliente); ?>"
                                                            data-apellido="<?php echo e($cliente->apellidoCliente); ?>"
                                                            data-empresa="<?php echo e($cliente->NombreEmpresa); ?>"
                                                            data-email="<?php echo e($cliente->emailCliente); ?>"
                                                            data-telefono="<?php echo e($cliente->telefonoCliente); ?>"
                                                            data-direccion="<?php echo e($cliente->direccionCliente); ?>">
                                                        <?php echo e($cliente->idCliente); ?> - <?php echo e($cliente->nombreCliente); ?> <?php echo e($cliente->apellidoCliente); ?> (<?php echo e($cliente->NombreEmpresa); ?>)
                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="repartidorPedido" name="repartidorPedido">
                                        ...
                                        <?php $__currentLoopData = $repartidores = \App\Models\Usuario::where('idRol', 3)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $repartidor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('VistasAdmin.welcome', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\RematesPaisaV2\resources\views/VistasAdmin/pedidos.blade.php ENDPATH**/ ?>